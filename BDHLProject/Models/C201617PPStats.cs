namespace BDHLProject.Models
{
    ...
    [Table("201617PPStats")]
    public partial class C201617PPStats
    {
        [StringLength(255)]
        ...
        public double? Assists1 { get; set; }

        public double? Points { get; set; }

        [Column("Points/60")]
        public double? Points_60 { get; set; }
        ...
        [Column("Player Usage")]
        public double? Player_Usage { get; set; }
        ...
        [Column("Zone Starts")]
        public double? Zone_Starts { get; set; }
        ...
        [Column("Off-Ice Team Stats")]
        public double? Off_Ice_Team_Stats { get; set; }
        ...
        [Column("Quality of Teammate Stats")]
        public double? Quality_of_Teammate_Stats { get; set; }
        ...
        [Column("Quality of Competition Stats")]
        public double? Quality_of_Competition_Stats { get; set; }
